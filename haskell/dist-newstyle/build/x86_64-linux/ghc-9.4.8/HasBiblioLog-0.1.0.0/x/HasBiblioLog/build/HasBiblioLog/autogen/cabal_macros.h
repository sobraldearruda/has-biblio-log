...
/* package HasBiblioLog-0.1.0.0 */
#ifndef VERSION_HasBiblioLog
#define VERSION_HasBiblioLog "0.1.0.0"
#endif /* VERSION_HasBiblioLog */
#ifndef MIN_VERSION_HasBiblioLog
#define MIN_VERSION_HasBiblioLog(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HasBiblioLog */
...
#define CURRENT_COMPONENT_ID "HasBiblioLog-0.1.0.0-inplace-HasBiblioLog"
